...
Layout: NHWC (mlx.nn.Conv2d convention). Channel = 3 (GENESIS-II arc1 ①: heat/
flow/pressure, matching GENESIS.md's "phenomena = channel dynamics" model —
see mu/field_env.py. Was channel=1 amplitude-only at mu-v0; bumped to 3 here,
no other shape/dispatch-count change needed since Conv2d in_channels is a
weight-shape param, not an extra op.).
...
HIDDEN = 128
CHANNELS = 3          # heat, flow, pressure (arc1 ①; was 1 amplitude-only at mu-v0)
